...
public class PurchasePanel : MonoBehaviour
{
    ...
    public static EquipmentPlace SelectedEquipmentPlace { get; private set; }
    ...
    { 
        if(!_bank.CheckBoughtEquipmentInRestaurant(EquipmentManager.InfoRestaurant.name, SelectedEquipmentPlace.equipmentInfo.name))
        {
            UpdateText(true);
    ...
    {
        if (SelectedEquipmentPlace != null)
        {
