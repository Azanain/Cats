...
public class EventManager : MonoBehaviour
{
    ...
    public Action<ButtonRestaurant> SelectRestaurantEvent;
   

    public Action<EquipmentInfo, int> AddLevelEquipmentEvent;

    public Action<bool> SaleModeEvent;
    ...
    public Action<bool> ChangeActivePanelUpgradeRestaurantEvent;
    ...
    public Action ConfirmSelectingRestaurantAndgoToItEvent;

    public Action<EquipmentTypes> UpgradeRestaurantIsBoughtEvent;
    ...
    public void SelectRestaurant(ButtonRestaurant buttonRestaurant)
    { SelectRestaurantEvent?.Invoke(buttonRestaurant); }
    ...
    public void ChangeActivePanelUpgradeRestaurant(bool isActive)
    { ChangeActivePanelUpgradeRestaurantEvent.Invoke(isActive); }
    public void ConfirmSelectingRestaurantAndgoToIt()
    { ConfirmSelectingRestaurantAndgoToItEvent?.Invoke(); }
    public void UpgradeRestaurantIsBought(EquipmentTypes type)
    { UpgradeRestaurantIsBoughtEvent?.Invoke(type); }
}
