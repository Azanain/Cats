...
public class RestaurantInfo : ScriptableObject
{
    ...
    [SerializeField] private EquipmentTypes[] _allTypesEquipmentsInRestautant;
    ...
    public EquipmentTypes[] AllTypesEquipmentsInRestautant => _allTypesEquipmentsInRestautant;
}
